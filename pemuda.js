///////Jangan Di Jual Om
//////Ini Sc Gratis Untuk Semua
////////Jadi Yah Tolong Banget Jangan Di Jual
///////Sc By Dcode Denpa 
//////Recode By MoDz Vip
//////YT : Zero One 01
////////Aim MoDz Vip : Zero One 01
//Jangan Yah Om
const
	{
...
await pemuda.updatePresence(from, Presence.recording)
} else if (autoketik) {
	if (autoketik === false) return
await pemuda.updatePresence(from, Presence.composing)
}
// Auto Read Private 
...
const isAntiVO = isGroup ? antiviewonce.includes(from) : false	
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "© MoDzBot", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/LdkNuInhE85D9g5h1OCOSg', "groupName": `${NamaBot}`, "footerText": "© MoDzBotz", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
//•======>> SUBSCRIBE : MoDz RxNc <<====•\\
			...
			var ase = new Date();
                ...
                case 12: jamss = "Sore"; break;
                case 13: jamss = "Sore"; break;
                case 14: jamss = "Sore"; break;
                case 15: jamss = "Sorr"; break;
...
const sendreply = (from, teks, faketeks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./media/image/pemuda.jpg'), surface: 200, message: `MoDz RxNc`, orderTitle: `MoDz RxNc`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true }})
...
const fvid = {
	 ...
	 { remoteJid: "6289523767913-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6289523767913-1616169743@g.us",
...
pemuda.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "© MoDzBotz", [{buttonId: 'simi', buttonText: {disText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
	...
	//•======>> SUBSCRIBE : MoDz RxNc <<====•\\
        ...
        const sendWebp = async(from, url) => {
	        ...
	        pemuda.sendMessage(from, { disname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
				...
				const reply = (teks) => {
			pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hai ${pushname}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://youtu.be/_aCjSjXdCAw`}}})
		}
		const simir = (teks) => {
...
pemuda.updatePresence(from, Presence.recording)
  ...
  case 'allmenu':
        ptod = "6289523767913@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
tescok = `${menunya(prefix)}`
Sendbutdocument(from, tescok, "© MoDz RxNc*", fs.readFileSync('./media/Project Pemuda.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./media/image/thumbnaildokumen.jpg'), filename:`MoDz Vip.pdf`, pageCount: 9999999 }, [{buttonId:`!000`,buttonText:{displayText:'Hai‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎\n\nGunakan bot dengan bijak yahh..'},type:1}], {quoted:fvid, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} - ${pushname}\nDownload Script`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/_aCjSjXdCAw`}}})
break
case 'menu':
case 'help':
stod = `${sender}`
...
│🔖${prefix}unpin':
│🔖${prefix}pin
│🔖${prefix}unarchiveall[ reply message ]
│
├─⬣ WAR MENU
│🔖${prefix}virtex
...
│🔖${prefix}ssweb [ reply link ]
└${prefix}MoDz Vip [ query ]`
katalog(menu)
break
case 'storagemenu':
menu = `⬣ 「 \`\`\`MENU STORAGE\`\`\` 」
...
case 'sewa':
       ...
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 👋🏻_* \n\nyakin nih mau sewa bot ? 🤔 Boong auto banned >_<`, "*MDz RxNc © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'🗿Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
 buttonText: 'CLICK HERE',
 footerText: '*MoDz RxNc © 2021*',
...
case '🕔sewa':
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*MoDz RxNc © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}py`,buttonText:{displayText:'NOMOR 📱'},type:1},{buttonId:`${prefix}qrsewa`,buttonText:{displayText:'QR CODE 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'py':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*MoDz RxNc © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}o1`,buttonText:{displayText:'OVO 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'GOPAY 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrsewa':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}🌹_\n\nSilahkan pilih metode pembayaran`, "*MoDz RxNc © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrg1`,buttonText:{displayText:'QR GOPAY 📱'},type:1},{buttonId:`${prefix}qro1`,buttonText:{displayText:'QR OVO 📱'},type:1},{buttonId:`${prefix}qrd1`,buttonText:{displayText:'QR DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qro1':
...
case 'sewaff2':
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}_\n\nSilahkan pilih metode pembayaran`, "MoDz RxNc © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa2`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
///===== PEMBATAS SEWA ====\\\
//// PEMBATAS MENU OWNER \\\
case 'ban':
...
const btnbc = {
    ...
    footerText: 'Broadcast MoDz RxNc © 2021',
    buttons: buttons,
    headerType: 1
}
...
client.browserDescription = ['MoDz RxNc','Desktop','3.0']
   ...
   case 'ssweb':
            case 'ss':
                if (args.length < 1) return reply('Urlnya mana om')
					...
					pemuda.sendMessage(from, buff, image, {quoted: mek, caption : teks})
					break
case 'artinama':
...
if (!isQuotedSticker) return reply(`Reply Stikernya`)
	...
	pempa = anee[0] !== "" ? anee[0] : `It's Me MDzVip`;
	autpa = typeof anee[1] !== "undefined" ? anee[1] : `YT : Zero One 01`;
...
"descriptionCount": "999999999",
  ...
  "businessOwnerJid": "6289523767913@s.whatsapp.net",
  "contextInfo": {
...
case 'x':
  if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
            ...
            "externalAdReply": {
                ...
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.ibb.co/BLgQQK4/7b2881aa825c.png",
                "thumbnail": fs.readFileSync(`./media/image/pemuda.jpg`),
                "sourceUrl": "https://youtu.be/_aCjSjXdCAw"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        pemuda.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{disText:'⚔️ MoDz RxNc ⚔️'},type:1}])
        pemuda.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
pemuda.sendMessage(from, {quoted: ftrol, thumbnail: fs.readFileSync('./media/virgam.jpeg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/_aCjSjXdCAw`}}})
break
//•======>> SUBSCRIBE : MoDz RxNc <<====•\\
case 'bugtroli2':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from,  `${menu}`, `${uwu}© MoDz RxNc ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT🔥'},type:1}, {buttonId:`${prefix}ofc`,buttonText:{displayText:'GRUP OFFICIAL👥'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
...
• https://github.com/delonle/MoDxVip
• https://youtu.be/_aCjSjXdCAw
`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: fvid, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 SCRIPT DISNI📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/script.jpg'),sourceUrl:"https://youtu.be/_aCjSjXdCAw"}}} )
...
• https://youtube.com/channel/UCCqG5su3V-OOLMK-UqQQkiA

Script Base punya :
• https://github.com/delonle/MoDxVip
• https://youtu.be/_aCjSjXdCAw
`, text, { thumbnail: dfrply , sendEphemeral: true,contextInfo: { mentionedJid: mem,forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 SCRIPT DISNI📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/script.jpg'),sourceUrl:"https://youtu.be/_aCjSjXdCAw"}}, quoted: fvid})
...
const kontil = body.slice(8)
                    ...
                    pemuda.sendMessage('6289523767913@s.whatsapp.net', options, text, {quoted: mek})
...
break
		case 'instainfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Instagram Pemilik Bot, Jangan Lupa Follow yak😉\n\nhttps://www.instagram.com/invites/contact/?i=5d9yl3t45ive&utm_content=n47rfeb", matchedText: 'https://www.instagram.com/invites/contact/?i=1ofq2ukyobq45&utm_content=n47rfeb', description: "", title: "KLIK UNTUK FOLLOW", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'youtubeinfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Youtube Pemilik Bot, Jangan Lupa Subcribe yak😉\n\nhttps://youtu.be/_aCjSjXdCAw", matchedText: 'https://youtube.com/channel/UCCqG5su3V-OOLMK-UqQQkiA', description: "", title: "KLIK UNTUK SUBCRIBE", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		
case 'partnerbot':
		pemuda.sendMessage(from, { text: "*Partne Bot MDz Team :\nhttps://wa.me/6289523767913?text=.menu\nThanks Udah Makek Bot ini😉", matchedText: 'https://youtu.be/_aCjSjXdCAw', description: "", title: "Yang klik Anak Haram", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'speed':
               case 'ping':
...
Giliran = @${tty.er1.split('@')[0]}`
 ...
 //•======>> SUBSCRIBE : MoDz RxNc <<====•\\
     ...
     pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Pemuda Bot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/pemuda.jpg'),sourceUrl:"https://youtu.be/_aCjSjXdCAw"}}})
	}
    }
    }
    }
